...
extension ChangePasswordVC {
    ...
    @IBAction func tappedOnNewCurrentPass(_ sender: Any) {
        if(isNewcurrentPass == true) {
            ...
            self.imgNewCurrentPass.image = UIImage(named: "visible")
            
        } else {
            txtReEnterNewPassword.isSecureTextEntry = true
            isNewcurrentPass = true
            self.imgNewCurrentPass.image = UIImage(named: "hide")
        }
    }
    ...
    @IBAction func tappedOnNewPass(_ sender: Any) {
        if(isNewPass == true) {
            ...
            isNewPass = false
            self.imgNewPass.image = UIImage(named: "visible")
            
        } else {
            txtNewPassword.isSecureTextEntry = true
            isNewPass = true
            self.imgNewPass.image = UIImage(named: "hide")
        }
    }
    ...
    @IBAction func tappedOnCurrentPass(_ sender: Any) {
        if(isCurrentPass == true) {
            ...
            isCurrentPass = false
            self.imgCurrentPass.image = UIImage(named: "visible")
            
        } else {
            txtOldPassword.isSecureTextEntry = true
            isCurrentPass = true
            self.imgCurrentPass.image = UIImage(named: "hide")
        }
    }
}
...
extension ChangePasswordVC{
    ...
    func changePasswordApiCall(isShowHud: Bool = false){
        ...
        parameter["current_password"] = txtOldPassword.text?.removeWhiteSpace()
        parameter["new_password"] = txtNewPassword.text?.removeWhiteSpace()
        
        WebService.call.withPath(WebURL.changepassword, parameter: parameter) { [weak self] (responseDic) in
