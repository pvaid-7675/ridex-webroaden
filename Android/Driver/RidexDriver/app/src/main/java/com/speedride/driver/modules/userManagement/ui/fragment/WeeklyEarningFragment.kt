 ...
 */
class WeeklyEarningFragment : BaseFragment() {
    private var mTxtWeeklyTrip: TextView? = null
    ...
    override fun initView(view: View?) {
        ...
        if (mScrollPagePos == 0) {
            if (ValidationUtils.isInternetAvailable(activityContext!!)) {
                //showProgress();
                Log.d(TAG, "initView: isFirstTime")
                isFirstTime = true
    ...
    private fun init(view: View) {
        ...
        mTxtWeeklyTrip = view.findViewById(R.id.txtTrip)
        mTxtWeeklyTrip!!.setText(R.string.weekly_trip)
    ...
    private fun apiGetEarningTypeList() {
        mApiGetEarningListCall = Singleton.restClient
            .getEarningList(mScrollPagePos.toString(), Common.EARNING_TYPE_WEEKLY)
    ...
    companion object {
        private val TAG = WeeklyEarningFragment::class.java.simpleName
    }
}